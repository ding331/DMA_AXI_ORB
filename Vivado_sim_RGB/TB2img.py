...
simulation_img = rowdata2img("D:\\Project_lab\\Vivado\\Harris_corner_1\\Harris_corner_1.srcs\\sim_1\\new\\Harris_TB.txt",-26,-6)
...
cv2.imshow('Harris_img',simulation_img)
cv2.imwrite('simulation_img.jpg',simulation_img)    #save
